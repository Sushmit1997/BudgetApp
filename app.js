 ...
 var data ={
     ...
     return{
         addItem: function(type, des, val){
             ...
             //return new item to other modules
             return  newItem;
         ...
         calculateBudget: function(){
             ...
             //Calculate the budget percentage
   ...
   return {
       getInput : function(){
           return {
             ...
             description : document.querySelector(DOMstrings.descripType).value,
       ...
       clearFields : function(){
          ...
          fields = document.querySelectorAll(DOMstrings.descripType + ',' + DOMstrings.inputValue + ',' + DOMstrings.inputBtn);
       ...
       displayBudget: function(obj){
           ...
           changedType: function(){
               var fields = document.querySelectorAll(
                   DOMstrings.inputtype + ',' +   DOMstrings.descripType + ',' + DOMstrings.inputValue);
